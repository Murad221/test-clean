        ...
        <div class="row">
            <div class="col-lg-8">
                @auth
                 ...
                 <div class="row mb-4">
                    ...
                    <form action="{{ route ('posts.destroy', ['post' => $post->id]) }}" method="POST"
                        onsubmit="return confirm('Ochirildi?');">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-sm btn-outline-danger" href=>
                            destroy
                        </button>
                    </form>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-2">
                        <a class="text-dark bg-secondary  rounded text-uppercase font-weight-medium" href="">{{ $post->category->name }}</a>
                    </div>
                ...
                <div class="mb-5">
                    ...
                    {{-- <div class="media mb-4">
                        <img src="/img/user.jpg" alt="{{ asset('storage/' .$post->photo)  }}" class="img-fluid rounded-circle mr-3 mt-1" style="width: 45px;">
                        <div class="media-body">
                ...
                <div class="bg-light rounded p-5">
                    ...
                    <div>Izoh qoldirish uchun
                        <a class="btn btn-danger" href="{{ route('login') }}"> Ro'yxatdan o'ting</a>
